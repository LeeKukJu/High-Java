...
<form action="./boardMailSend.do" id="sendForm" method="post">
...
<!-- 메일 전송하기 폼 -->
  ...
  <div class="mb-3" style="border: 1px;">
	...
	<div class="mb-3" style="padding-top: 30px; padding-left: 30px; padding-right: 30px;">
	  ...
	  <input type="text" class="form-control" name="mailReceiver" value="<%=receiver %>" style="width: 50%;">
