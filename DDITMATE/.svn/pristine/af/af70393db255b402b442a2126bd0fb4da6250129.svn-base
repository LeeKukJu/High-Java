...
<body>
    ...
    <nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow">
        <div class="container d-flex justify-content-between align-items-center">
            <a class="navbar-brand h1" href="<%=application.getContextPath()%>/manager/managerMain.jsp">
...
<!--                         </li> -->
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="<%=application.getContextPath()%>/board/studyProject.jsp">스터디/프로젝트</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="<%=application.getContextPath()%>/board/employmentInfo.jsp">취업정보</a>
                        </li>
                    </ul>
                </div>
                <div class="navbar align-self-center d-flex">
                    <a class="nav-link" href="#"><i class='bx bx-bell bx-sm bx-tada-hover text-primary'></i></a>
                    <a class="nav-link" href="/DDITMATE/member/memCheck.do"><i class='bx bx-user-circle bx-sm text-primary'></i></a>
                    <a class="nav-link" href="logout.do"><i class='bx bx-log-out bx-sm text-primary'></i></a>
                </div>
            </div>
        </div>
    </nav>