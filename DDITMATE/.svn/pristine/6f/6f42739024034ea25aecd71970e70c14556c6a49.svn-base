...
// 받은 쪽지함
@WebServlet("/mail/mailReceiveList.do")
public class MailReceiveListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<MailVO> mailList = mailService.receiveAllList(memId);
		
		req.setAttribute("mailList", mailList);
		req.setAttribute("mailBox", "send");
