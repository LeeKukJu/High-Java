...
public class pagingUtil {
	...
	public static <K,V> Map<K, V> boardPaging(String cateCode, String pageTemp) {
		Map<String, Object> paging = new HashMap<String, Object>();
		paging.put("cateCode", cateCode);
		IBoardService boardService = BoardServiceImpl.getInstance();
		
		int totalCount = boardService.selectCount(paging);
	...
	public static <K,V> Map<K, V> boardSearch(String cateCode, String pageTemp, String searchWord) {
		Map<String, Object> paging = new HashMap<String, Object>();
