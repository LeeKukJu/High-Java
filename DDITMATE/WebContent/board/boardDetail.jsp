...
<!-- 신고 모달 -->
                  ...
                  <div id="modal" class="modal-overlay">
                      <div class="modal-window">
                       ...
                       <div>
                           <input type="submit" class="btn" value="확인" style="color: white; background-color: rgb(129, 112, 91);">
                           <button type="button" class="close-area btn">취소</button>
                       </div> 
                   </div>
               </div>
               </form>
<!-- 신고 모달 -->
      ...
      <div class="row pb-4 justify-content-center col-md-8 m-auto">
         <div class="worksingle-comment-body">
<!--             <div class="d-flex"> -->
            <div>
               ...
               <%
                ...
                %> 
                  ...
                  <div class="comment-new m-auto" style="text-align:end;" id="<%=mv.getMentNo()%>">
                     <%
...
// 	console.log($(this).parents('.comment-hidden').attr('id'));
	$(this).parents('.comment-hidden').attr('style','display: hidden');
});
