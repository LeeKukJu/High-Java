...
class ShareData {
	 ...
	 */
	volatile private boolean isOk = false; // 원주율 계산이 완료되었는지를 나타내기 위한 변수
...
class CalcPIThread extends Thread {
	...
	public void run() {
		...
		sd.setResult(sum * 4); // 계산된 원주율값을 고유객체에 저장하기
		sd.setOk(true); // 계산이 완료되었을음 설정한다.
	}
}
