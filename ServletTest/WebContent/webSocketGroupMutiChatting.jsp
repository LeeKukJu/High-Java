...
<body>
	<div id="">
			...
			<tr>
				<td style="vertical-align: top;">
					<div id="chatArea">
						...
						<!-- 송신 버튼 -->
						<input type="button" value="Send" onclick="sendMessage()"> <input type="button" value="접속종료" onclick="closing()">
					</div>
				</td>
				<td>
					<div id="chatRoom">
						<input type="text" id="newRoomName"> <input type="button" value="채팅방만들기" onclick="createRoom()">
						<br>
						<br>
						채팅방 목록
						<br>
						...
						<br>
						<input type="button" value="채팅방 입장" onclick="chatRoomIn()">
						<br>
						<br>
		...
		<div id="connectArea">
			<!-- 접속자 입력 텍스트박스 -->
			사용자ID : <input type="text" id="userId" size="20" onkeyup="enterKey();">
			<!-- 접속 버튼 -->
