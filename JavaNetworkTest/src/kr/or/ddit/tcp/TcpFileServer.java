...
public class TcpFileServer {
	// 서버는 클라이언트가 접속하면 클라이언트가 요청하는 파일을 제공한다.
	...
	public void serverStart() throws IOException {
		...
		String downDir = "D:\\D_Other\\images\\";
		...
		while(true) {
			...
			if(!file.exists()) {
				System.out.println("요청하신 파일(" + file.getName() + ")는 존재하지 않습니다.");
				dos.writeUTF("요청하신 파일(" + file.getName() + ")는 존재하지 않습니다.");
